<template>
  <main class="content">
    ...
    <section>
      ...
      <p>Indefinite Leave to Remain requires the applicant to only leave the country for certain amount of days within either 5 or 10 years.</p>
    </section>
