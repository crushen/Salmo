...
export default {
  mixins: [ clickaway ],
  props: {
    holiday: { required: true, type: Array },
    index: { required: true, type: Number }
  },
  data() {
    return {
      form: {
        location: this.holiday[this.index].location,
        start: this.holiday[this.index].start,
        end: this.holiday[this.index].end,
        days: null
      },
      errors: {
        start: false,
  ...
  methods: {
    ...
    validateForm() {
      ...
      if(!this.$v.form.$invalid && !this.errors.dates && !this.errors.start && !this.errors.end) {
        ...
        this.holiday[this.index] = this.form;
