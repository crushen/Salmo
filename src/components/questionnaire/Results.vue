  ...
  created() {
    ...
    if(this.result === 'Tier 5 Creative and Sporting Visa') {
      if(this.currentVisa === 'Standard Visitor Visa') {
        this.switchMessage = 'You can switch to this visa if you’re in the UK as a sports or entertainer visitor, as long as your sponsor gave you a certificate of sponsorship for this visa before you came to the UK.';
      }
    }
    
    if(this.result === 'Tier 2 Sportsperson Visa') {
      if(this.currentVisa.includes('Intra-company Transfer')) {
        this.switchMessage = 'You can switch to this visa if you’re applying to change sponsor';
      } else if(this.currentVisa.includes('Tier 4')) {
        this.switchMessage = 'You can switch to this visa if you have an eligible qualification or you’ve done at least 12 months of a PhD';
      } else if(this.currentVisa === 'Tier 5 Creative and Sporting Visa') {
        this.switchMessage = "You can switch to this visa if you're a professional footballer";
    ...
    if(this.result === 'Tier 2 Minister of Religion Visa') {
      if(this.currentVisa.includes('Intra-company Transfer')) {
        ...
        this.switchMessage = 'You can switch to this visa if you have an eligible qualification';
      } else if(this.currentVisa.includes('Tier 1') ||
         this.currentVisa.includes('Tier 2') ||
         this.currentVisa === 'Startup Visa' ||
         this.currentVisa === 'Innovator Visa') {
    ...
    if(this.result === 'Tier 1 Exceptional Talent Visa') {
      if(this.currentVisa === 'Tier 5 GOV Authorised Exchange Visa') {
        this.switchMessage = "You can switch to this visa if you're on an exchange scheme for sponsored researchers";
      } else if(this.currentVisa.includes('Tier 1') ||
         this.currentVisa.includes('Tier 2') ||
         this.currentVisa === 'Startup Visa' ||
         this.currentVisa === 'Innovator Visa') {
    ...
    if(this.result.includes('Innovator Visa')) {
      if(this.currentVisa === 'Tier 1 Graduate Entrepreneur Visa' ||
        ...
        this.switchMessage = 'You can switch to this visa if you came to the UK to get funding and had a supporting letter from an endorsing body';
      }
    }
    ...
    if(this.result.includes('Startup Visa')) {
      if(this.currentVisa === 'Tier 1 Graduate Entrepreneur Visa' ||
        ...
        this.switchMessage = "You can switch to this visa, but you will need to get a supporting letter from an endorsing body to prove you're looking for funding";
      }
    }
    // STUDY
